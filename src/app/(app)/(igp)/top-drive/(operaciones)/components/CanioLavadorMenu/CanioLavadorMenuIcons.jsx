function getColorByState(currentValue, totalValue, selected, planPozoActive) {
  const typeState = {
    1: '#52B358',
    2: '#F4DD48',
    3: '#D03F49',
  ...
  if (!planPozoActive) return typeState[4];
...
export function UpperIBOPIcon({
  ...
  return (
    ...
    >
      <DropShadowFilter />
      <path
        fill={getColorByState(hours, maxHours, selected, planPozoActive)}
        fillRule="evenodd"
