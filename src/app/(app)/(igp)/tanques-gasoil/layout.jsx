...
export const metadata = {
  title: {
    default: 'Tanques de Gasoil',
  },
};

export default function TanquesGasoilLayout({ children }) {
  return (
    <div className="mt-2 mx-5 pb-5">
      <div className="flex items-center justify-between mb-2">
        <h1 className="text-xl font-medium">Tanques de Gasoil</h1>
        <div
        ...
        <div className="flex justify-between items-center gap-4">
          <BackButton href="/" />
          <SelectorPerforadores onlyDrillers showAccess={false} showAll />
        </div>
      </div>
      {children}
    </div>
